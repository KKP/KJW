...
1. Booking Listing (Filters tab) admin panel. Apply filter, for looking of your required bookings.
1. Booking Listing (Actions tab) admin panel. Approve, decline, delete and make other actions for selected bookings.
